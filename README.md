...
-# Jogo Investigativo IA 

Projeto de desenvolvimento de um jogo **single player**, para PC, com estética **pixel art**, ambientado em uma empresa de tecnologia de IA.
...
`BACKLOG → A FAZER → EM ANDAMENTO → DESENVOLVIMENTO → CODE REVIEW → QA/PLAYTEST → CONCLUÍDO`

Coluna especial: `BLOQUEADO`
